...
{
    private static final long serialVersionUID = -3550175655051965107L;
    ...
    static Entry executeInsert(HttpTransport transport, Entry entry, String postLink)
            throws IOException
    {
    ...
    {
        return Link.find(links, Link.Rel.ENTRY_EDIT);
    }

    public String getFeedLink()
    {
        return Link.find(links, Link.Rel.FEED);
    }
}
